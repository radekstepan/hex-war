...
export const territoriesData = {
    ...
    'scandinavia': { name: 'Scandinavia', continent: 'Europe', gridX: 5, gridY: 0, adj: ['iceland', 'great-britain', 'northern-europe', 'ukraine'] },
    ...
    // Asia (Compacted Layout)
    'ural': { name: 'Ural', continent: 'Asia', gridX: 7, gridY: 1, adj: ['ukraine', 'siberia', 'china', 'afghanistan'] },
    'siberia': { name: 'Siberia', continent: 'Asia', gridX: 7, gridY: 0, adj: ['ural', 'yakutsk', 'irkutsk', 'mongolia', 'china'] },
    ...
    'china': { name: 'China', continent: 'Asia', gridX: 7, gridY: 3, adj: ['afghanistan', 'ural', 'siberia', 'mongolia', 'siam', 'india'] },
    ...
    'india': { name: 'India', continent: 'Asia', gridX: 7, gridY: 4, adj: ['middle-east', 'afghanistan', 'china', 'siam'] },
    'siam': { name: 'Siam', continent: 'Asia', gridX: 8, gridY: 4, adj: ['india', 'china', 'indonesia'] },
    
    // Australia (Corrected Connections)
...
export const PLAYER_COLORS = ['#38a169', '#2c5282', '#c53030', '#d69e2e', '#805ad5']; // Green, Blue, Red, Yellow, Purple
